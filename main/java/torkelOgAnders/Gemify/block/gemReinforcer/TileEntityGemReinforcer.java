...
import cpw.mods.fml.relauncher.SideOnly;
	...
	public class TileEntityGemReinforcer extends TileEntity implements ISidedInventory {
		...
		public String getInventoryName() {
			return this.hasCustomInventoryName() ? this.furnaceName : "Gem Reinforcer";
		}
	...
	public int getCookProgressScaled(int par1) {
		...
		public void updateEntity() {
			...
			if (flag != this.furnaceBurnTime > 0) {
				flag1 = true;
				GemReinforcer.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
		}
		...
		private boolean canSmelt() {
			if (this.furnaceItemStacks[0] == null) {
				...
				ItemStack itemstack = RecipesGemReinforcer.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
		...
		public static int getItemBurnTime(ItemStack itemstack){
			if(itemstack == null){
				...
				if(item == Gemify.gemDiamerald) return 200;
