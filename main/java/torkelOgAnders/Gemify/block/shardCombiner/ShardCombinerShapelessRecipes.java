...
public class ShardCombinerShapelessRecipes implements IRecipe
{
	public int craftingsize = 2; //change to edit size of table
    ...
    public ShardCombinerShapelessRecipes(ItemStack p_i1918_1_, List p_i1918_2_)
    {
