...
public class ShardCombinerShapedRecipes implements IRecipe
{
	
	public int craftingsize = 2;
    ...
    public ShardCombinerShapedRecipes(int p_i1917_1_, int p_i1917_2_, ItemStack[] p_i1917_3_, ItemStack p_i1917_4_)
    {
    ...
    {
        for (int i = 0; i <= craftingsize - this.recipeWidth; ++i)
        {
            for (int j = 0; j <= craftingsize - this.recipeHeight; ++j)
            {
    ...
    {
        for (int k = 0; k < craftingsize; ++k)
        {
            for (int l = 0; l < craftingsize; ++l)
            {
                int i1 = k - p_77573_2_;
                int j1 = l - p_77573_3_;
    ...
    public ShardCombinerShapedRecipes func_92100_c()
    {
