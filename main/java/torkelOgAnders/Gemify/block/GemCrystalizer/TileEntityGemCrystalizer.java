...
public class TileEntityGemCrystalizer extends TileEntity implements ISidedInventory {
	...
	public String getInventoryName() {
		return this.hasCustomInventoryName() ? this.furnaceName : "Gem Crystalizer";
	}
	...
	public void updateEntity() {
		...
		if (flag != this.furnaceBurnTime > 0) {
			flag1 = true;
			GemCrystalizer.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
	}
	...
	private boolean canSmelt() {
		if (this.furnaceItemStacks[0] == null) {
			...
			ItemStack itemstack = RecipesGemCrystalizer.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
	...
	public static int getItemBurnTime(ItemStack itemstack){
		if(itemstack == null){
			...
			if(item == Items.gold_ingot) return 50;
