...
public class ContainerGemStation extends Container {
	...
	public ContainerGemStation(InventoryPlayer invPlayer, World world, int x, int y, int z) {
	...
	public void onCraftMatrixChanged(IInventory iinventory) {
		craftResult.setInventorySlotContents(0, GemStationCraftingManager.getInstance().findMatchingRecipe(craftMatrix, worldObj));
	}

	
	@Override
	public boolean canInteractWith(EntityPlayer player) {
		if(worldObj.getBlock(posX, posY, posZ) != Gemify.machineGemStation) {
			return false;
		}else{
