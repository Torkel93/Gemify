...
public class GemStationShapelessRecipes implements IRecipe
{
	public int craftingsize = 5; //change to edit size of table
    ...
    public GemStationShapelessRecipes(ItemStack p_i1918_1_, List p_i1918_2_)
    {
