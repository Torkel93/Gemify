...
public class GemStationCraftingManager
{
    /** The static instance of this class */
    private static final GemStationCraftingManager instance = new GemStationCraftingManager();
     ...
     */
    public static final GemStationCraftingManager getInstance()
    {
        /** The static instance of this class */
        return instance;
    }
    ...
    private GemStationCraftingManager()
    {
        recipes = new ArrayList();
        
        this.addRecipe(new ItemStack(Items.apple, 15), new Object[] {"S", "S", "S", "S", "S", 'S', Items.stick});
    	
    	Collections.sort(this.recipes, new GemStationRecipeSorter(this));
    }

  //Adding recipes------------------------------------------------------
    
    public GemStationShapedRecipes addRecipe(ItemStack p_92103_1_, Object ... p_92103_2_)
    {
        String s = "";
        int i = 0;
        int j = 0;
        ...
        GemStationShapedRecipes shapedrecipes = new GemStationShapedRecipes(j, k, aitemstack, p_92103_1_);
