...
public class GemStationShapedRecipes implements IRecipe
{
	
	public int craftingsize = 5;
    ...
    public GemStationShapedRecipes(int p_i1917_1_, int p_i1917_2_, ItemStack[] p_i1917_3_, ItemStack p_i1917_4_)
    {
    ...
    public GemStationShapedRecipes func_92100_c()
    {
