...
public class ContainerGemInfuser extends Container {
	
	private TileEntityGemInfuser tileFurnace;
	private int lastCookTime;
	private int lastBurnTime;
	private int lastItemBurnTime;
	
	public ContainerGemInfuser(InventoryPlayer player, TileEntityGemInfuser tileEntityFurnace){
			...
			public ItemStack transferStackInSlot(EntityPlayer player, int par2){
				...
				if(slot != null && slot.getHasStack()){
					...
					if(par2 == 2){
						...
						if(RecipesGemInfuser.smelting().getSmeltingResult(itemstack1) != null){
							if(!this.mergeItemStack(itemstack1, 0, 1, false)){
								return null;
							}
						}else if(TileEntityGemInfuser.isItemFuel(itemstack1)){
