...
public class TileEntityGemInfuser extends TileEntity implements ISidedInventory {
	...
	public String getInventoryName() {
		return this.hasCustomInventoryName() ? this.furnaceName : "Gem Infuser";
	}
...
public int getCookProgressScaled(int par1) {
	...
	public void updateEntity() {
		...
		if (flag != this.furnaceBurnTime > 0) {
			flag1 = true;
			GemInfuser.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
	}
	...
	private boolean canSmelt() {
		if (this.furnaceItemStacks[0] == null) {
			...
			ItemStack itemstack = RecipesGemInfuser.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
	...
	public static int getItemBurnTime(ItemStack itemstack){
		...
		//		}
			...
			if(item == Items.diamond) return 200;
